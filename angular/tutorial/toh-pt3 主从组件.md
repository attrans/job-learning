...
<app-hero-detail [hero]="selectedHero"></app-hero-detail>
```
[hero]="selectedHero" 是 Angular 的[属性绑定](https://angular.cn/guide/template-syntax#property-binding)语法。  
...
像[以前](https://angular.cn/tutorial/toh-pt2)一样，一旦用户点击了一个英雄的名字，该英雄的详情就显示在了英雄列表下方。 现在，HeroDetailComponent 负责显示那些详情，而不再是 HeroesComponent。
...
你的应用应该变成了这样 [在线例子](https://angular.cn/generated/live-examples/toh-pt3/stackblitz.html) / [下载范例](https://angular.cn/generated/zips/toh-pt3/toh-pt3.zip)。本页所提及的代码文件如下：
